            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Icon(Ionicons.logo_instagram,color: Colors.white,size: 40,),
                    SizedBox(width: 13,),
                    Icon(Ionicons.logo_facebook,color:Colors.white,size: 40,),
                    SizedBox(width: 13,),
                    Icon(Ionicons.logo_google,color:Colors.white,size: 40,),
                  ],
                ),
              )
            ],
